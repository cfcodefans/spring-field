...
open class DatabaseLoader {
    ...
    open fun init(quoterRepo: QuoteRepo): CommandLineRunner {
        return CommandLineRunner { args ->
            ...
            quoterRepo.save(Quote(quote = "Spring has come quite a ways in addressing developer enjoyment and "
            ...
            quoterRepo.save(Quote(quote = "Spring Boot solves this problem. It gets rid of XML and wires up "
            ...
            quoterRepo.save(Quote(quote = "It embraces " + "convention over configuration, providing an experience on par with "
                    + "frameworks that excel at early stage development, such as Ruby on " + "Rails."))
            quoterRepo.save(Quote(quote = "The real benefit of Boot, however, is that it's just Spring. That "
                    + "means any direction the code takes, regardless of complexity, I know " + "it's a safe bet."))
            quoterRepo.save(Quote(quote = "I don't worry about my code scaling. Boot allows the "
            ...
            quoterRepo.save(Quote(quote = "@springboot with @springframework is pure productivity! Who said in #java one has "
                    + "to write double the code than in other langs? #FavLib"))
        }
    }
}
